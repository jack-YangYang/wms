<template> 
    ...
    >  
        ...
        <el-table-column prop="shop_name" label="店铺简称" align="center" />
        ...
        <el-table-column prop="prevent_apply_staff_name" label="发起人" align="center" />
        <el-table-column prop="prevent_apply_date" label="发起时间" align="center" />
        <el-table-column prop="prevent_check_staff_name" label="审核人" align="center"></el-table-column>    
        <el-table-column prop="prevent_check_date" label="审核时间" align="center" />
        <el-table-column prop="order_type" label="订单状态" align="center" />
        <el-table-column prop="prevent_status" label="单据状态" align="center" />
