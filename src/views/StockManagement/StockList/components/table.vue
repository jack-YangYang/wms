<template> 
    ...
    >  
        ...
        <el-table-column prop="skuUsableCount" label="SKU可用用数量" align="center" />  
        ...
        <!-- <el-table-column prop="skuAmount" label="成本金额/成本单价" align="center">
            <template slot-scope="{row}">
                {{ row.skuAmount }}/{{ row.skuPrice }}
            </template>
        </el-table-column> -->
  </el-table>
</template>
...
export default {
    ...
    methods: {
        getSummaries(param) {
            const summariesList = ['skuCount', 'skuOccupyCount', 'skuUsableCount']
