    ...
    <main>
        <el-form inline>
            ...
            <el-form-item>
                ...
                <el-button @click="exportData({search, whouseId, sku, isTrans: false})" size="mini" type="primary">导出</el-button>
            </el-form-item>
        </el-form>
        <template v-if="!total">
           <table-list 
...
export default {
    ...
    computed: {
        ...mapState({
            total: state => state.StockBill.total,
            tableData: state => state.StockBill.tableData,
    ...
    methods: {
        ...
        getData(arg) {
            ...
            this.getList({ whouseId: this.whouseId, sku:this.sku || 0, params:this.search, isTrans: false })
        },
        remoteMethod(query) {
            debounce(() => {
