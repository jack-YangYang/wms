<template>
    <el-form ref="form" :model="form" label-width="80px" inline>
        ...
        <el-form-item>
            <el-input placeholder="请输入单号" clearable v-model.trim="form.ticketCode" />
        </el-form-item>
        <el-form-item>
        ...
        <el-form-item>
            <el-select v-model="form.type"  clearable   placeholder="请选择入库类型">
                    <el-option
                        v-for="item in otherInTypeList"
                        :key="item.val"
                        :label="item.name"
                        :value="item.val"
                    />
