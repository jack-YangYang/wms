<template>
    <div class="left">
        ...
        <div>
            <span>出库类别:</span>
            <el-select v-if="show" v-model="detail.type">
                <el-option v-for="item in outTypeList" :label="item.name" :value="item.val" :key="item.val" />
            </el-select>
...
export default {
    ...
    methods: {
        ...mapMutations('OtherOut', ['CAHNGE_ITEMS', 'CHANGE_HOUSE']),
