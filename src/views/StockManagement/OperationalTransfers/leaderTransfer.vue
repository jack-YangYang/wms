<template>
    <main>
        ...
        <div v-if="leadertoTal">
           <table-list 
           @doAudit="doAudit"
           :showButtons="showButtons"
           :tableData="leaderTableData"
            />
            <change-page 
...
import { getMenuID, clearSearch } from '@/utils/common'
export default {
    computed: {
    ...
    methods: {
        handleSubmit(state) {
            ...
            this.leaderAudit({ data, params: this.search })
        },
        doReset() {
            this.date = null
        ...
        getData(arg) {
            ...
            this.getLeaderData(this.search)
        },

        ...mapActions(['getAllShop', 'getAllwarehouse']),
        ...mapActions('OperationalTransfers', ['getLeaderData', 'leaderAudit', 'getButtonList']),
