<template>
    <main> 
        ...
        <table-content :tableData="detailItems" @handleSelectionChange="handleSelectionChange" :show="false"  @deleteData="deleteData"  />
...
import detail from './components/detailHead'
...
export default {
    ...
    computed: {
        ...
        uploadAddress() {
            return `${process.env.VUE_APP_FBA_API}/warehouse/sku/import/${this.detail.sourceWhouseId}/0/${false}`
        }
    },
    data() {
        return {
