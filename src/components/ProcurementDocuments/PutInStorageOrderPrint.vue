        ...
        <div id="ProcurementDocuments">
            <Header>
                ...
                <div>
                    ...
                    <div>
                        <barcode :value="detail.ticketCode" tag="img" :width="1.5" :height="40" :fontSize="14" />       
                    </div>
                    <div>
            ...
            <component :is="component" :tableData="detailItems" :state="detail.state" :detail="detail" :remark="detail.remark" />
        </div>
...
import fallbackTable from './fallbackTable.vue'
...
export default {
    ...
    methods: {
        confirm(flag) {
            ...
            this.$emit('confirmPrint', this.detail.ticketCode)
        }
    },
    mounted() {
    }
